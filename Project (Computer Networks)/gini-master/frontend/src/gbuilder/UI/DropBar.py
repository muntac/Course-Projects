...
class DropBar(Dockable):
    def __init__(self, title, parent):
        ...
        dropArea = DropArea(commonTypes)
        dropArea2 = DropArea(hostTypes.keys())
        dropArea3 = DropArea(netTypes.keys())
        
        self.toolBox.addItem(dropArea, self.tr("&Common Elements"))
        self.toolBox.addItem(dropArea2, self.tr("&Host Elements"))
        self.toolBox.addItem(dropArea3, self.tr("&Net Elements"))
